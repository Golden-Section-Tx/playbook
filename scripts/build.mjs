...
/* --- llms.txt ----------------------------------------------------------- */
{
  const out = [
    ...
    'Adaptations must carry the same licence. Golden Section names and marks are not',
    'licensed. Alternative terms on request: open an issue.',
    '',
    '## Whole corpus in one file',
    '',
    `- [dist/playbook-full.md](dist/playbook-full.md): everything below, single file, with attribution and licence in its header. Prefer this for ingestion.`,
    '',
    '## Primary documents',
    '',
