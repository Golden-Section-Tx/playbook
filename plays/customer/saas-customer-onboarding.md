...
h1: How to Build a SaaS Customer Onboarding Process
category: customer
players: CS Lead, Implementation
initialEffort: 13 SP
ongoingEffort: 8 SP
frequency: Per Customer
stage: Early Traction
templates:
  - file: 3.11-onboarding-process-template.xlsx
...
questions:
  ...
  - How do I improve my onboarding process over time?
  - How do I measure onboarding success?
  - Who should be accountable for onboarding new customers?
  - What's the connection between onboarding and churn?
preventsMistakes:
---
...
**Templates** · [Onboarding Process Template](../../templates/3.11-onboarding-process-template.xlsx)

**Category** · [Customer](../README.md) · **Effort** · 13 SP initial, 8 SP ongoing · **Cadence** · Per Customer
